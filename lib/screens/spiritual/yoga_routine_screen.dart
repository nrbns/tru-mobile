                    ...
                    return Padding(
                      ...
                      child: AuraCard(
                        child: Column(
                          ...
                          children: [
                            Text((s['name'] ?? 'Yoga Session') as String,
                                style: const TextStyle(
                                    color: Colors.white,
                                    fontWeight: FontWeight.w600)),
                            const SizedBox(height: 6),
                            Text(
                                '${s['duration'] ?? 20} min • ${(s['level'] ?? 'beginner')} • ${(s['focus'] ?? 'relaxation')}',
                                style: TextStyle(
