...
final communityFeedProvider = StreamProvider.family<List<Map<String, dynamic>>, Map<String, dynamic>>((ref, params) {
...
final supportGroupsProvider = FutureProvider<List<Map<String, dynamic>>>((ref) async {
  return ref.watch(communityServiceProvider).getSupportGroups();
});

final communitySettingsProvider = FutureProvider<Map<String, dynamic>>((ref) async {
