...
final gratitudeJournalServiceProvider = Provider((ref) => GratitudeJournalService());

final gratitudeEntriesStreamProvider = StreamProvider.family<List<GratitudeJournalEntry>, int>((ref, limit) {
