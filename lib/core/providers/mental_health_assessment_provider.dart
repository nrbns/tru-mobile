...
final mentalHealthAssessmentServiceProvider = Provider((ref) => MentalHealthAssessmentService());

/// FutureProvider for PHQ-9 questions
final phq9QuestionsProvider = FutureProvider<List<Map<String, dynamic>>>((ref) async {
...
final gad7QuestionsProvider = FutureProvider<List<Map<String, dynamic>>>((ref) async {
  final service = ref.watch(mentalHealthAssessmentServiceProvider);
  return service.getGAD7Questions();
});

/// StreamProvider for assessment history (real-time)
final assessmentHistoryStreamProvider = StreamProvider.family<List<Map<String, dynamic>>, Map<String, dynamic>>((ref, params) {
  final service = ref.watch(mentalHealthAssessmentServiceProvider);
...
final assessmentTrendsProvider = FutureProvider.family<List<Map<String, dynamic>>, Map<String, dynamic>>((ref, params) async {
  final service = ref.watch(mentalHealthAssessmentServiceProvider);
